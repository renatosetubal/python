...
frameBaixo = Frame(janela, width=300, height=290, bg=co9, relief="solid")
frameBaixo.grid(row=2,column=0)

#Logo APP
app_logo = Label(frameCima, text="Budget", compound=LEFT, padx=5, relief="flat",
                 anchor=NW, font=("Verdana 20"), bg=co1, fg=co4)
...
botao_calcular = Button(frameMeio, anchor=NW, text="Calcular".upper(), overrelief=RIDGE, font=("Ivy 9"), bg=co1, fg=co0 , command=calcular)
